    ...
    <header className="bg-white border-b border-sage-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <button
            className="md:hidden p-2 rounded-md text-sage-500 hover:bg-sage-50 transition-colors"
      ...
      {mobileOpen && (
        <nav className="md:hidden border-t border-sage-100 bg-white">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${
                    isActive ? "bg-sage-100 text-sage-800 font-medium" : "text-sage-500 hover:bg-sage-50"
                  }`}
                >
                  {icons[item.icon]}
                  {item.label}
