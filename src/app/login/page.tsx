...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-sage-50 via-white to-sage-100">
      {/* Decorative background shapes */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-sage-200/40 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-[30rem] h-[30rem] rounded-full bg-sage-300/30 blur-3xl" />
        <div className="absolute top-1/3 left-1/4 w-64 h-64 rounded-full bg-sage-100/60 blur-2xl" />
      </div>
      ...
      >
        {/* Card */}
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-2xl shadow-sage-900/10 border border-sage-200/50">
          {/* Brand */}
          <motion.div
          ...
          >
            ...
            <h1 className="text-2xl font-bold text-sage-800 tracking-tight">Warmindo</h1>
            <p className="text-sm text-sage-400 mt-1.5 font-medium">Sistem Kasir</p>
          </motion.div>
